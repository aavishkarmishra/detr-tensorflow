...
class ResNetBase(tf.keras.Model):
    def __init__(self, **kwargs):
        ...
        self.conv1 = Conv2D(64, kernel_size=7, strides=2, padding='valid', use_bias=False, name='conv1')
...
class ResidualBlock(tf.keras.Model):
    def __init__(self, num_bottlenecks, dim1, dim2, strides=1, replace_stride_with_dilation=False, **kwargs):
        super().__init__(**kwargs)
...
class BottleNeck(tf.keras.Model):
    def __init__(self, dim1, dim2, strides=1, dilation=1, downsample=False, **kwargs):
        ...
        self.conv2 = Conv2D(dim1, kernel_size=3, strides=strides, dilation_rate=dilation, use_bias=False, name='conv2')
        ...
        self.downsample_conv = Conv2D(dim2, kernel_size=1, strides=strides, use_bias=False, name='downsample_0')
